...
<tileset version="1.9" tiledversion="1.9.2" name="platform -grass(transparency) to water-spritesheet" tilewidth="32" tileheight="32" tilecount="870" columns="30">
 <image source="../../Tilesets/Platform - grass to water/platform -grass(transparency) to water-spritesheet.png" width="960" height="929"/>
 <tile id="30">
  <animation>
