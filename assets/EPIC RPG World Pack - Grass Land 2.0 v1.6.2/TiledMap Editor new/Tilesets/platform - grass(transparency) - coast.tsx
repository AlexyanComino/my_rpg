...
<tileset version="1.9" tiledversion="1.9.2" name="platform - grass (transparency)- coast - spritesheet" tilewidth="32" tileheight="32" tilecount="986" columns="34">
 <image source="../../Tilesets/Platform - grass to water/platform - grass(transparency) - coast - spritesheet.png" width="1088" height="953"/>
 <tile id="1">
  <animation>
