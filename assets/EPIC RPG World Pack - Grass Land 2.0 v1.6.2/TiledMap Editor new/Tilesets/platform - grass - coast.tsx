...
<tileset version="1.9" tiledversion="1.9.2" name="platform - grass2 - coast - spritesheet" tilewidth="32" tileheight="32" tilecount="986" columns="34">
 ...
 <wangsets>
  <wangset name="platform - grass2 to coast (sea)" type="corner" tile="172">
